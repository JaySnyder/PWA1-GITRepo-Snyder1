...
//console.log('------ numbers ----------');
//long numbers, small numbers, ex:
//var y= 123e5; //12300000 move decimal right (5 zeros)
//var z= 123e-5 //0.00123 move decimal left (Minus)
    // arithmetic operators:  +, -, /, *, % (modulo)
//plus, minus, divide, multiply, modulo (Remainder)
...
//var num1 = 10;
//var num2 = 5;
//num1 += num2; //another way of writing this out
// or num1 = num1 + num2; --- Same results ((Quick Operators))
...
console.log("Sum = ", array1[0] + array1[1] + array1[2] + array1[3]);
...
*/
//var myVar = 5 > 3;
//console.log(myVar); //is 5 greater than 3  True
...
//}
     //both statements are true, string one and number 1 are equal.

//TRIPLE EQUAL - String and number are NOT EQUAL! with ===
...
/*******************************************
 ...
 1. copy the block of code from STUDENT ACTIVITY 4 DONE
...
var value2 = 5;
 ...
 var moodType = moodFN(value1, value2) ; //value1 & value2 are now 'weather and waves"
                     // PASSING IN ^
